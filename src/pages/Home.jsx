...
const Home = () => {
  ...
  return (
    <>
         <div className='w-full  h-[130px] pt-3 px-2 bg-white border-b-2 sticky top-0 flex flex-col justify-between'  style={sectionStyle} >
             ...
             <div>
               <div className='flex pb-[5px] gap-2'>
                 <Link className='text-xs focus:underline
                       underline-offset-8 decoration-4
                       decoration-[#408dfb]'>Dashboard</Link>
                 <Link className='text-xs focus:underline
                      underline-offset-8 decoration-4 
                    decoration-[#408dfb]'>Announcements</Link>
                 <Link className='text-xs focus:underline 
                      underline-offset-8 decoration-4
                     decoration-[#408dfb]' >Recent Updates</Link>
               </div> 
             </div>
         </div>
      ...
      <div className='flex flex-col px-2 py-6 gap-2 tables'>
              ...
              <div className='w-3/4'><img src={totalreceivables} alt="totalreceivables" /></div>
              <div className='w-3/4' ><img src={salesAndExpense} alt="salesAndExpense" /></div>
              <div className='w-3/4 flex'>
                <div><img src={project} alt="project" /></div>
                <div><img src={topexpenses} alt="topexpenses" /></div>
              </div>
