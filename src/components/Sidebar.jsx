...
const Sidebar = ({sidesShow,setSideShow}) => {
  
  const sideShowHandle = () => {
    setSideShow(!sidesShow)
  }

  console.log(sidesShow)
  return (
    <div
      className="bg-[#21263c] 
    ...
    >  
      {sidesShow ? (
          <Link to="/">
          <div
            className=" py-2 px-2  flex text-sm  items-center justify-center 
                              bg-[#181c2e] rounded-b-lg text-white "
          >
            <svg
        ...
        <div
          className="mt-0 ml-0  py-2 px-2  flex text-sm gap-1 justify-start 
      ...
      <div className="flex flex-col p-2 gap-[3px] justify-between items-center">
        ...
        <Link
          to="/home"
          className="text-white py-3 px-3 mt-1 rounded-lg focus:bg-[#408dfb] hover:bg-[#181c2e]
        ...
        >
         ...
         {sidesShow ? (
          ...
          <Link
            ...
            to={link.link}
            className=" text-white  py-2 px-2 rounded-lg focus:bg-[#408dfb] hover:bg-[#181c2e]
                       flex justify-center gap-2 w-full items-center no-underline"
          >
          ...
          <Link
            ...
            className="group text-white py-2 px-2 rounded-lg focus:bg-[#408dfb] hover:bg-[#181c2e]
                       flex justify-between text-[12px] w-full items-center no-underline"
          >
        ...
        */}
        {sidesShow ? (
             <button 
             onClick={sideShowHandle}
             className=' text-white py-3 px-3 mt-1 rounded-md  bg-[#181c2e]
                           flex justify-center  text-xs items-center'>
                   <MdOutlineArrowForwardIos />
          </button>
         ) : (
          <button 
          onClick={sideShowHandle}
          className='group text-white py-2 px-2 rounded-md  bg-[#181c2e]
                        flex justify-center text-xs w-full items-center'>
                 <MdArrowBackIos />
       </button>
         )}
      </div>
